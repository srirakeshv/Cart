...
let divElement=document.querySelector('.product img')

boxes.forEach((box,index)=>{
    box.querySelector('.box img').src=array[index].image
    box.querySelector('.box p').innerHTML=array[index].name

    box.addEventListener('click',()=>{
        const num=index
        const imageUrl=array[num].image
        const text=array[num].name
        const priceTag=array[num].price
        const desc=array[num].description
        console.log(imageUrl)
        localStorage.setItem('img', imageUrl)
        localStorage.setItem('text', text)
        localStorage.setItem('price', priceTag)
        localStorage.setItem('desd', desc)
